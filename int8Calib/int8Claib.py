...
# Train the mod
results = model.train(data='/home/mjy/ultralytics/data/drone3.yaml',batch=16,epochs=1,imgsz=704)

# 根据校准集生成int8 engine 
model = YOLO("/home/mjy/ultralytics/pp/best.pt")
model.export(format='engine',int8=True,dynamic=True,batch=16,data='/home/mjy/ultralytics/data/drone3.yaml',imgsz=704)

# 测试
model = YOLO('/home/mjy/ultralytics/pp/best.engine') 
metrics = model.val(data='/home/mjy/ultralytics/data/drone2.yaml',split='test',imgsz=704,batch=16)
